    ...
    <div className={`neu-outset p-5 rounded-[28px] flex flex-col gap-4 transition-all duration-500 hover:scale-[1.01] relative group ${className}`}>
      ...
      <div className="flex justify-between items-start">
        <div className="flex flex-col">
          <span className="text-[10px] font-black tracking-widest uppercase text-[#31456a]/40">
            {label || "Alarm"}
          </span>
          <div className="mt-1 flex items-baseline gap-1">
            <span className={`text-4xl font-black transition-colors duration-300 tabular-nums ${isActive ? 'text-[#31456a]' : 'text-[#31456a]/20'}`}>
              {time}
            </span>
            <span className={`text-xs font-bold uppercase ${isActive ? 'text-[#31456a]/60' : 'text-[#31456a]/10'}`}>
              {period}
            </span>
          </div>
        </div>
      ...
      {/* Sunrise Simulation Option */}
      <div className="pt-2 border-t border-[#31456a]/5 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className={`p-1.5 rounded-lg transition-colors ${sunriseEnabled ? 'bg-orange-100 text-orange-400 shadow-inner' : 'bg-[#31456a]/5 text-[#31456a]/30'}`}>
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-bold text-[#31456a]/60 uppercase tracking-tighter leading-none">Sunrise Mode</span>
            <span className="text-[8px] font-medium text-[#31456a]/30 uppercase tracking-tight">30m Gradual Brighten</span>
          </div>
        </div>
